...
public class PersonTest {
	...
	public static void main(String[] args) {
		...
		Student homo1 = new Student("Sally", "655 Place Dr. GA", "asdf@email.com",
				"6780043354", "Junior");
		Employee homo2 = new Employee("Dan", "445 Kind dr. TN", "fghj@email.com",
				"7701123323", false, "$1", "09 Jan 2018");
		Faculty homo3 = new Faculty("Jesse", "3434 Lance Dr. KY", "kjhh@email.com",
				"5574434434", true, "$60,000", "18 Jan 2013", "3pm - 5pm, Mon - Thurs", "Arch Code-Breaker");
		Staff homo4 = new Staff("Jamie", "7655 Hey Ct. LA", "ertert@email.com",
